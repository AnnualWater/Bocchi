...
public class BocchiDbContext :
    AbpDbContext<BocchiDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    /* Add DbSet properties for your Aggregate Roots / Entities here. */
    public DbSet<PluginSwitchEntity> PluginSwitchItems { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(BocchiConsts.DbTablePrefix + "YourEntities", BocchiConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
        builder.Entity<PluginSwitchEntity>(b =>
        {
        ...
        {
            b.ToTable(BocchiConsts.DbTablePrefix + "ComicSubscription", BocchiConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
            //...
        });
    }
